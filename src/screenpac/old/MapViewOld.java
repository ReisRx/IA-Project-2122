...
public class MapViewOld extends JComponent implements Constants {
    ...
    public static void test(Maze maze) {
        new JEasyFrame(new MapViewOld(maze), "Map Test", true);
    }

    Maze maze;

    public MapViewOld(Maze maze) {
        this.maze = maze;
    }
